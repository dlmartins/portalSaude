...
!(function (t, e) {
    ...
    class et extends R {
        ...
        _addTouchEventListeners() {
            ...
            V.find(".carousel-item img", this._element).forEach((t) => {
                ...
                this._pointerEvent
                    ? (H.on(this._element, "pointerdown.bs.carousel", (e) => t(e)), H.on(this._element, "pointerup.bs.carousel", (t) => i(t)), this._element.classList.add("pointer-event"))
                    : (H.on(this._element, "touchstart.bs.carousel", (e) => t(e)), H.on(this._element, "touchmove.bs.carousel", (t) => e(t)), H.on(this._element, "touchend.bs.carousel", (t) => i(t)));
        }
        _keydown(t) {
    ...
    class wt {
        ...
        activate() {
            ...
            this._isActive ||
                (e && t.focus(), H.off(document, ".bs.focustrap"), H.on(document, "focusin.bs.focustrap", (t) => this._handleFocusin(t)), H.on(document, "keydown.tab.bs.focustrap", (t) => this._handleKeydown(t)), (this._isActive = !0));
        }
        deactivate() {
    ...
    class Lt extends R {
        ...
        _initializeBackDrop() {
            return new bt({ className: "offcanvas-backdrop", isVisible: this._config.backdrop, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: () => this.hide() });
        }
        _initializeFocusTrap() {
            return new wt({ trapElement: this._element });
        }
    ...
    class Bt extends R {
        ...
        show() {
            ...
            z.set(n, this.constructor.DATA_KEY, this),
                this._element.ownerDocument.documentElement.contains(this.tip) || (l.append(n), H.trigger(this._element, this.constructor.Event.INSERTED)),
        ...
        setElementContent(t, e) {
            if (null !== t)
                return a(e)
                    ? ((e = l(e)), void (this._config.html ? e.parentNode !== t && ((t.innerHTML = ""), t.append(e)) : (t.textContent = e.textContent)))
