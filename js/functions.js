(function ($) {
  ...
  function dataCustomOptions() {
    ...
    //       $(this).css(
    //         "background-image",
    //         "url('/images/files/parallax-bg/Background1.jpeg')"
    //       );
    //     } else {
    //       $(this).css(
    //         "background-image",
    //         "url('/images/files/parallax-bg/Background2.jpeg')"
    //       );
    //     }
    //   });
  }
        ...
        setTimeout(function () {
          setTimeout(function () {
            b.children("h1, .separator-dots")
              ...
              .animate({ top: 0 }, { duration: 400, easing: "easeOutExpo" });
          }, 0),
            setTimeout(function () {
  ...
  function appointmentFormValidation() {
    ...
    // Submit event
    $("#appointment-form").on("submit", function (a) {
      if (a.isDefaultPrevented()) {
        var b = '<i class="af-error-icon fa fa-close"></i>' + errorMsg;
        afSubmitMSG(!1, b), afError();
      } else a.preventDefault(), afSubmitForm();
    });
  }
